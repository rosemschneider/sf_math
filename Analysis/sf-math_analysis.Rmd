...
Change the age for two participants with incorrect age
```{r}
...
ggplot(initial_final, aes(x = initial_highest, y = final_highest, color = factor(productive, 
                                                                                 labels = c("Productive", "Nonproductive")))) +
  geom_point(size = 2) + geom_jitter(width = .1) +
  labs(x = "Final highest count", y = "Initial highest count",
...
ggplot(initial_final, aes(x = initial_highest, 
                          fill = factor(productive, labels = c("Productive", "Nonproductive")))) + 
