...
```{r 3_tasks, fig.pos = "h", fig.width=3.5, fig.height=2.5, fig.cap = "Mean performance for Unit, Next Number, and Math Facts tasks by Productivity. Bars represent mean performance, with error bars indicating mean standard error. Violin plots indicate density distribution of responses."}
...
```{r prod_mod_vis, fig.pos = "b", fig.width=3.5, fig.height=2.5, fig.cap = "Estimates of predictor coefficients for the full model. Continuous predictors (Math Facts, HCNN, FHC, and Age) are scaled and center. Values above 0 indicate increased likelihood of an accurate Unit Task response. Error bars indicate 95\\%  confidence intervals."}
# library(dotwhisker)
